...
import com.google.game.rl.IRLTask;
...
//	public class AppleflingerGame extends ApplicationAdapter {
	...
	public static IRLTask RL_TASK;
	
	public AppleflingerGame(ActionResolver actionResolver, IRLTask RL_TASK) {
		super();
		this.actionResolver = actionResolver;
		AppleflingerGame.RL_TASK = RL_TASK;
	}
...
//	gm.setGameState(GameState.LOADING_SCREEN);
	...
	@Override
	public void render() {
        if (RL_TASK.get("simple", false)) {
            Gdx.gl.glClearColor(0.0f, 0.0f, 0.0f, 1); // WHITE
        } else {
            Gdx.gl.glClearColor(0.0f, 0.0f, 0.0f, 1); // BLACK
        }
		...
		if (GameManager.DEBUG)
			if (secondStart < TimeUtils.millis()-1000L)
			{
