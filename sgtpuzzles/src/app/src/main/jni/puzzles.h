...
extern void android_game_state_changed(const char* name, const char* value);
extern void android_game_state_changed_int(const char* name, const int value);
extern void android_game_state_changed_float(const char* name, const float value);
extern void android_solved_changed(int is_solved);
